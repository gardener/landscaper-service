...
build-int-test-image:
	@docker build integration-test/docker -t eu.gcr.io/gardener-project/landscaper-service/integration-test:1.19.10-alpine3.18
	@docker push eu.gcr.io/gardener-project/landscaper-service/integration-test:1.19.10-alpine3.18
