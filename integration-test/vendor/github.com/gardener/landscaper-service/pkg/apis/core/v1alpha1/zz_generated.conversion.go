...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HighAvailabilityConfig)(nil), (*core.HighAvailabilityConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_HighAvailabilityConfig_To_core_HighAvailabilityConfig(a.(*HighAvailabilityConfig), b.(*core.HighAvailabilityConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.HighAvailabilityConfig)(nil), (*HighAvailabilityConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_HighAvailabilityConfig_To_v1alpha1_HighAvailabilityConfig(a.(*core.HighAvailabilityConfig), b.(*HighAvailabilityConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_HighAvailabilityConfig_To_core_HighAvailabilityConfig(in *HighAvailabilityConfig, out *core.HighAvailabilityConfig, s conversion.Scope) error {
	out.ControlPlaneFailureTolerance = in.ControlPlaneFailureTolerance
	return nil
}

// Convert_v1alpha1_HighAvailabilityConfig_To_core_HighAvailabilityConfig is an autogenerated conversion function.
func Convert_v1alpha1_HighAvailabilityConfig_To_core_HighAvailabilityConfig(in *HighAvailabilityConfig, out *core.HighAvailabilityConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_HighAvailabilityConfig_To_core_HighAvailabilityConfig(in, out, s)
}

func autoConvert_core_HighAvailabilityConfig_To_v1alpha1_HighAvailabilityConfig(in *core.HighAvailabilityConfig, out *HighAvailabilityConfig, s conversion.Scope) error {
	out.ControlPlaneFailureTolerance = in.ControlPlaneFailureTolerance
	return nil
}

// Convert_core_HighAvailabilityConfig_To_v1alpha1_HighAvailabilityConfig is an autogenerated conversion function.
func Convert_core_HighAvailabilityConfig_To_v1alpha1_HighAvailabilityConfig(in *core.HighAvailabilityConfig, out *HighAvailabilityConfig, s conversion.Scope) error {
	return autoConvert_core_HighAvailabilityConfig_To_v1alpha1_HighAvailabilityConfig(in, out, s)
}
...
func autoConvert_v1alpha1_InstanceRegistrationStatus_To_core_InstanceRegistrationStatus(in *InstanceRegistrationStatus, out *core.InstanceRegistrationStatus, s conversion.Scope) error {
	out.ObservedGeneration = in.ObservedGeneration
	out.LandscaperDeploymentInfo = (*types.NamespacedName)(unsafe.Pointer(in.LandscaperDeploymentInfo))
...
func autoConvert_v1alpha1_InstanceSpec_To_core_InstanceSpec(in *InstanceSpec, out *core.InstanceSpec, s conversion.Scope) error {
	...
	out.HighAvailabilityConfig = (*core.HighAvailabilityConfig)(unsafe.Pointer(in.HighAvailabilityConfig))
	return nil
}
...
func autoConvert_core_InstanceSpec_To_v1alpha1_InstanceSpec(in *core.InstanceSpec, out *InstanceSpec, s conversion.Scope) error {
	...
	out.HighAvailabilityConfig = (*HighAvailabilityConfig)(unsafe.Pointer(in.HighAvailabilityConfig))
	return nil
}
