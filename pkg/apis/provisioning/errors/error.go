...
type Error struct {
	lssErr provisioningv1alpha2.Error
	err    error
}
...
func (e *Error) LandscaperServiceError() *provisioningv1alpha2.Error {
...
func TryUpdateError(lastErr *provisioningv1alpha2.Error, err error) *provisioningv1alpha2.Error {
	if err == nil {
		return nil
	}
...
func UpdatedError(lastError *provisioningv1alpha2.Error, operation, reason, message string) *provisioningv1alpha2.Error {
	newError := &provisioningv1alpha2.Error{
		Operation:          operation,
		Reason:             reason,
		Message:            message,
		LastTransitionTime: metav1.Now(),
...
func (e Error) UpdatedError(lastError *provisioningv1alpha2.Error) *provisioningv1alpha2.Error {
