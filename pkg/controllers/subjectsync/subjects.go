...
import (
	...
	dataplanesv1alpha2 "github.com/gardener/landscaper-service/pkg/apis/dataplane/v1alpha1"
)

// CreateSubjectsForSubjectList converts the subjects of the SubjectList custom resource into rbac subjects.
func CreateSubjectsForSubjectList(ctx context.Context, subjectList *dataplanesv1alpha2.SubjectList) []rbacv1.Subject {
...
func createSubjectForSubjectListEntry(subjectListEntry dataplanesv1alpha2.Subject) (*rbacv1.Subject, error) {
