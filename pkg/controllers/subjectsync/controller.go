...
type Controller struct {
	...
	ReconcileFunc func(ctx context.Context, subjectList *dataplanev1alpha1.SubjectList) (reconcile.Result, error)
}
...
func (c *Controller) Reconcile(ctx context.Context, req reconcile.Request) (reconcile.Result, error) {
	...
	// set finalizer
	if subjectList.DeletionTimestamp.IsZero() && !kutils.HasFinalizer(subjectList, constants.LandscaperServiceFinalizer) {
		controllerutil.AddFinalizer(subjectList, constants.LandscaperServiceFinalizer)
...
func (c *Controller) reconcile(ctx context.Context, subjectList *dataplanev1alpha1.SubjectList) (reconcile.Result, error) {
