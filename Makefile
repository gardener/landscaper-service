...
build-int-test-image:
	@docker buildx build --platform linux/amd64 integration-test/docker -t eu.gcr.io/gardener-project/landscaper-service/integration-test:1.21.4-alpine3.18 --push
