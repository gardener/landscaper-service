...
type Controller struct {
	...
	ReconcileFunc    func(ctx context.Context, deployment *provisioningv1alpha2.LandscaperDeployment) error
	HandleDeleteFunc func(ctx context.Context, deployment *provisioningv1alpha2.LandscaperDeployment) error
}
...
func (c *Controller) Reconcile(ctx context.Context, req reconcile.Request) (reconcile.Result, error) {
	...
	// set finalizer
	if deployment.DeletionTimestamp.IsZero() && !kutils.HasFinalizer(deployment, constants.LandscaperServiceFinalizer) {
		controllerutil.AddFinalizer(deployment, constants.LandscaperServiceFinalizer)
...
func (c *Controller) handleErrorFunc(deployment *provisioningv1alpha2.LandscaperDeployment) func(ctx context.Context, err error) error {
