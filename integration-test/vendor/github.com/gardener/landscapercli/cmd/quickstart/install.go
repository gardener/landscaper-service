...
func (o *installOptions) installLandscaper(ctx context.Context) error {
	...
	landscaperChartURI := fmt.Sprintf("oci://europe-docker.pkg.dev/sap-gcp-cp-k8s-stable-hub/landscaper/charts/landscaper --untar --version %s", o.landscaperChartVersion)
